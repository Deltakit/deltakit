...
To get the logical error probability per round with a quantum memory experiment, for example, you can use the rotated planar code to encode a logical qubit:
