...
class TestLambdaPropagation:
    ...
    def test_lambda_shifted_fit_stddev(self, seed: int) -> None:
        # The lambda and lambda0 stddevs from correlated_values must match the
...
class TestGradientPropagation:
    ...
    def test_lambda_reciprocal_stddev(
        ...
        # The 1/lambda stddev from unumpy must match the previously used manual
        # formula: |stddev / lambda^2|.
